...
export const DEFAULT_CONTENT: SiteContent = {
  hero: {
    ...
    subtitle:
      'Pracuję z zabieganymi ludźmi, którzy chcą odzyskać energię i ' +
      'pewność siebie dzięki dopasowanym treningom i pracy nad ' +
      'nawykami.',
  ...
  about: {
    title: 'Jak pracuję',
    intro:
      'Łączę trening siłowy, mobilność i dbanie o regenerację. ' +
  ...
  tiles: [
    {
      ...
      description:
        'Analiza postawy, mobilności i stylu życia pozwala dobrać ' +
        'najefektywniejszą drogę do wyniku.'
    },
    {
      title: 'Plan 360°',
      description:
        'Trening, regeneracja i mikro cele tygodniowe. Wszystko w ' +
        'jednym dashboardzie dostępnym na telefonie.'
    },
    {
      title: 'Stała komunikacja',
      description:
        'Szybkie konsultacje na czacie i cykliczne sesje video, by ' +
        'przystosować plan do Twojego życia.'
    },
    {
      title: 'Wynik i utrzymanie',
      description:
        'Kończymy dopiero, gdy wiesz jak samodzielnie utrzymać formę ' +
